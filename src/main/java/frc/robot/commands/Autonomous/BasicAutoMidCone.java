...
public class BasicAutoMidCone extends SequentialCommandGroup {
  /** Creates a new BasicAuto. */
  public BasicAutoMidCone(ArmSubsystem arm, EndEffectorSubsystem effector, Command driveCommand) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new EffectorToState(false, effector), 
      new tempArmToSetpoint(ArmSetpoint.MID_CONE.angleDegrees, ArmSetpoint.MID_CONE.length, arm),
